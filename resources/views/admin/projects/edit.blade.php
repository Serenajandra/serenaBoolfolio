...
@section('content')
    ...
    <form class="container" action="{{ route('admin.projects.update', $project->id) }}" method="POST">
        ...
        <div class="mb-3 form-group">
            ...
            <textarea class="form-control" id="presentation" name="presentation" rows="5">{{ $project->presentation }}</textarea>
        </div>

        <div class="mb-3 form-group">
            <label for="content" class="form-label">Contenuto</label>
            <textarea class="form-control" id="content" rows="10" name="content">{{ $project->content }}</textarea>
        </div>
